...
frappe.query_reports["Monthly Attendance Sheet (S)"] = {
	"filters": [
		{
			"fieldname": "month",
			"label": __("Month"),
	...
	onload: function() {
		return  frappe.call({
			method: "sampat_industries.sampat_industries.report.monthly_attendance_sheet_(s).monthly_attendance_sheet(s).get_attendance_years",
			callback: function(r) {
